...
Section "PsychoPy" PsychoPy
  ...
  WriteRegStr HKLM "${REG_UNINSTALL}" "DisplayIcon" "$INSTDIR\Lib\site-packages\psychopy\psychopy.ico" 
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$StartMenuFolder\PsychoPyIDE.lnk" \
      "$INSTDIR\pythonw.exe" "$\"$INSTDIR\Lib\site-packages\PsychoPyIDE\PsychoPyIDE.py$\"" "$INSTDIR\Lib\site-packages\psychopy\psychopy.ico"
