...
* :blue:`CHANGED: removed python 2.4's version of sha1 digest from :class:'~psychopy.info.RunTimeInfo'`
...
* :blue:`CHANGED: gui.Dlg and gui.dlgFromDict can now take a set of choices and will convert`
