...
There is now a Javascript equivalent to the PsychoPy Python library. It's called PsychoJS and, just like the PsychoPy (Python) library Builder can generate experiments for you using that library.
