...
For developers the best way to use PsychoPy is to install a version to your own copy of python (preferably 3.6 but we try to support a reasonable range). Make sure you have all the :ref:`dependencies`, including the extra :ref:`suggestedPackages` for developers.
