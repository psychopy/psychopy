...
* Improved documentation. A lot of the docs haven't yet been written, and I plan to make a movie demo or two (for youtube?). I guess this is the most important thing right now.
