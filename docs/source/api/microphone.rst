...
**AdvAudioCapture()** allows advanced audio recording, with onset-marker sound insertion and detection, loudness (RMS).
...
----------------------
Compression requires that `flac` is installed on your computer. It is not included with PsychoPy by default,
