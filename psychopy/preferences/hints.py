...
_translate("Color theme to use for syntax highlighting")
...
# baseNoArch.spec,[hardware],line116
...
# Windows.spec,[app],line64
_translate("Enable High-DPI awareness on Windows, requires restart. (EXPERIMENTAL)")
