...
_translate("open Coder files as read-only (allows running without accidental changes)")
...
#baseNoArch.spec,[builder],line109
...
#baseNoArch.spec,[connections],line122
