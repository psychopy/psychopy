...
from psychopy.hardware.camera.camera_ffpyplayer import FFPyPlayerCameraDevice
...
# class CameraDevice(BaseDevice):
    ...
    #     # camera objects registered with this interface
    #     self._clients = set()

    #     # threaded timer to periodically read frames from the camera stream
    #     self._pollingTimerThread = None
    #     self._pollingThreadLock = threading.Lock()

    # def bindClient(self, camera):
    #     """Bind a camera object to this interface.

    #     Parameters
    #     ----------
    #     camera : Camera
    #         Camera object to bind to this interface.

    #     """
    #     self._clients.add(camera)
    
    # def unbindClient(self, camera):
    #     """Unbind a camera object from this interface.

    #     Parameters
    #     ----------
    #     camera : Camera
    #         Camera object to unbind from this interface.

    #     """
    #     self._clients.discard(camera)

    # def unbindAllClients(self):
    #     """Unbind all camera objects from this interface.
    #     """
    #     self._clients.clear()
    
    # def getClients(self):
    #     """Get all camera objects bound to this interface.

    #     Returns
    #     -------
    #     set[Camera]
    #         Set of camera objects bound to this interface.
    ...
    #     # setup automatic polling of the camera stream to read frames at regular intervals
    ...
    #         with self._pollingThreadLock:
    #             self._capture.close_player()

    # def _pollFFPyPlayer(self):
    #     """Poll the camera stream opened with FFmpeg (ffpyplayer).
        
    #     This method should be called to poll the camera stream and read any
    #     new frames that are available.

    #     """
    #     with self._pollingThreadLock:
    #         recentFrames = self._getFramesFFPyPlayer()

    #     if recentFrames and self._clients:
    #         for client in self._clients:
    #             client._onNewFrames(recentFrames)
...
CameraInterface = FFPyPlayerCameraDevice
...
CameraDevice = FFPyPlayerCameraDevice
_openCameras = {}
...
class Camera:
    ...
    def _doFrameTasks(self):
        """Perform tasks for each new frame.

        This is called to run computer vision tasks on each new frame.
        """
        pass
