...
def findPhotometer(ports=None, device=None):
    ...
    if isinstance(device, basestring):
        ...
        # photometer
        photometers = [getPhotometerByName(d) if isinstance(
            d, basestring) else d for d in device]
    else:
    ...
    for thisPort in ports:
        ...
        for Photometer in photometers:
            ...
            try:
                ...
                logging.error("Couldn't initialize photometer {0}: {1}".format(
                    Photometer.__name__, ex))
            ...
            if photom.OK:
                ...
                # now increase the number of attempts made to communicate for
