...
class Experiment:
    ...
    def __init__(self, prefs=None):
        ...
        #  _implicitLoop is a hack to allow saving data from components not inside
        ...
        self._implicitLoop.type = 'ExperimentHandler'  # true at run-time
        self._implicitLoop.name = self._implicitLoop.params['name'].val  # thisExp
