...
class BuilderFrame(wx.Frame):
    ...
    def makeMenus(self):
        ...
        self.toolsMenu.Append(self.IDs.runFile, _("Run\t%s") %self.app.keys['runScript'], "Run the current script")
        wx.EVT_MENU(self, self.IDs.runFile,  self.runFile)
        self.toolsMenu.Append(self.IDs.stopFile, _("Stop\t%s") %self.app.keys['stopScript'], "Abort the current script")
