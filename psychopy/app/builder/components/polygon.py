...
tooltip = _translate(
    'Polygon: any regular polygon (line, triangle, square...circle)')
...
class PolygonComponent(BaseVisualComponent):
    ...
    def __init__(self, exp, parentName, name='polygon', interpolate='linear',
        ...
        self.params['nVertices'] = Param(nVertices, valType='int',
                                         ...
                                         hint=_translate(
                                             "How many vertices? 2=line, 3=triangle... (90 approximates a circle)"),
                                         label=_localized['nVertices'])
        self.params['fillColorSpace'] = Param(fillColorSpace, valType='str', allowedVals=['rgb', 'dkl', 'lms', 'hsv'],
                                              updates='constant',
                                              hint=_translate(
                                                  "Choice of color space for the fill color (rgb, dkl, lms, hsv)"),
        ...
        self.params['fillColor'] = Param(fillColor, valType='str', allowedTypes=[],
                                         ...
                                         hint=_translate(
                                             "Fill color of this shape; Right-click to bring up a color-picker (rgb only)"),
        ...
        self.params['lineColor'] = Param(lineColor, valType='str', allowedTypes=[],
                                         updates='constant', allowedUpdates=['constant', 'set every repeat', 'set every frame'],
                                         hint=_translate(
                                             "Line color of this shape; Right-click to bring up a color-picker (rgb only)"),
