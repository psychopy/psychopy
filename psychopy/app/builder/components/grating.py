...
class GratingComponent(BaseVisualComponent):
    ...
    def __init__(self, exp, parentName, name='grating', image='sin',
        ...
        # params
        msg = "The (2D) texture of the grating - can be sin, sqr, sinXsin... or a filename (including path)"
        ...
        msg = "Spatial frequency of image repeats across the grating in 1 or 2 dimensions, e.g. 4 or [2,3]"
        ...
        msg = "Spatial positioning of the image on the grating (wraps in range 0-1.0)"
