...
class RatingScaleComponent(BaseComponent):
    ...
    def __init__(self, exp, parentName,
                 ...
                 disappear=False,
                 storeRating=True, storeRatingTime=True, oldChoiceBehavior=False,
        ...
        self.params['advancedParams'] = ['singleClick', 'forceEndRoutine', 'size', 'disappear',
                        'pos', 'storeRatingTime', 'storeRating', 'oldChoiceBehavior', 'lowAnchorText', 'highAnchorText', 'customize_everything']
        ...
        self.params['oldChoiceBehavior'] = Param(oldChoiceBehavior, valType='bool', allowedTypes=[],
    ...
    def writeInitCode(self, buff):
        ...
        if self.params['customize_everything'].val.strip() != '':
            ...
            if self.params['visualAnalogScale'].val:
                ...
                if self.params['oldChoiceBehavior'].val:
