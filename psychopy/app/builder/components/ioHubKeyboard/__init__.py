# ** This File is just a place holder for the ioHubKeyboard Component. It
#    was created by copying the existing Keyboard components files.
...
iconFile = path.join(thisFolder, 'ioHubKeyboard.png')
tooltip = _translate('ioHub Keyboard: check and record key press / release events.')
...
class IoHubKeyboardComponent(BaseComponent):
    ...
    def __init__(self, exp, parentName, name='key_resp',
        ...
        super(IoHubKeyboardComponent, self).__init__(
            exp, parentName, name,
            startType=startType, startVal=startVal,
            stopType=stopType, stopVal=stopVal,
            startEstim=startEstim, durationEstim=durationEstim)

        self.type = 'ioHubKeyboard'
        self.url = "http://www.psychopy.org/builder/components/ioHubKeyboard.html"
