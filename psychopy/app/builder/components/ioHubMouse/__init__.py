# ** This File is just a place holder for the ioHubMouse Component. It
#    was created by copying the existing Mouse components files.
...
iconFile = path.join(thisFolder, 'ioHubMouse.png')
tooltip = _translate('ioHubMouse: query mouse position and buttons')
...
class ioHubMouseComponent(BaseComponent):
    ...
    def __init__(self, exp, parentName, name='mouse',
        ...
        super(ioHubMouseComponent, self).__init__(
            exp, parentName, name=name,
            startType=startType, startVal=startVal,
            stopType=stopType, stopVal=stopVal,
            startEstim=startEstim, durationEstim=durationEstim)

        self.type = 'ioHubMouse'
        self.url = "http://www.psychopy.org/builder/components/ioHubMouse.html"
