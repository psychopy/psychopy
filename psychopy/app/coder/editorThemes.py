...
STYLE_SPEC_LANG = {
    'psychopy': {  # wxPython demo style
        ...
        'lexerStyles': {
            ...
            'commentblock': "fore:#7F7F7F,size:%(size)d",
    ...
    'wx': {  # wxPython demo style
        ...
        'lexerStyles': {
            'default': "fore:#000000,face:%(code)s,size:%(size)d",
            'comment': "fore:#008000,back:#F0FFF0',face:%(comment)s,size:%(size)d",
            'commentline': "fore:#008000,back:#F0FFF0',face:%(comment)s,size:%(size)d",
    ...
    'github': {  # github style
        'editor': {  # editor default styles, applied before lexer specific
            ...
            'default': {
                ...
                wx.stc.STC_STYLE_BRACELIGHT: 'fore:#c8e1ff,back:#f1f8ff',
        ...
        'lexerStyles': {
            ...
            'commentblock': "fore:#969896,size:%(size)d",
