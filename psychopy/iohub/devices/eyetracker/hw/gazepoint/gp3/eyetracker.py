...
class EyeTracker(EyeTrackerDevice):
    ...
    def __init__(self,*args,**kwargs):        
        ...
        # Do any GP3 device config based on device config settings in yaml
        # file here.
        # ...
        #
        ...
        # Connect to the eye tracker server by default. Do not record data though
    ...
    def trackerTime(self):
        ...
        """
        if self._eyetribe:
             # TODO Replace with TET code to get current device's time.
