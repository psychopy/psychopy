...
# class GazepointPsychopyCalibrationGraphicsOLD:
...
#
#             if num_points == 3:
#                 GazepointPsychopyCalibrationGraphicsOLD.CALIBRATION_POINT_LIST = [(0.5, 0.1),
#                                                                                (0.1, 0.9),
#                                                                                (0.9, 0.9)]
#             elif num_points == 5:
#                 GazepointPsychopyCalibrationGraphicsOLD.CALIBRATION_POINT_LIST = [(0.5, 0.5),
#                                                                                (0.1, 0.1),
#                                                                                (0.9, 0.1),
#                                                                                (0.9, 0.9),
#                                                                                (0.1, 0.9)]
