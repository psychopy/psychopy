...
class ioHubConnection(object):
    ...
    def _addDeviceView(self,name,device_class_name):
        try:
            ...
            print "_addDeviceView: ", name, device_class_name
            import psychopy.iohub.ioclient
            local_class = None
            local_module = getattr(psychopy.iohub.ioclient, name, False)
            print 'local_module:',name,local_module
            if local_module:
                local_class = getattr(local_module, device_class_name, False)
            print 'local_class:',device_class_name, local_class
            d=None
            if local_class:
                d = local_class(self, name, device_class_name)
            else:
