...
class Renderbuffer(object):
    ...
    @staticmethod
    def create(width, height, internalFormat=GL.GL_RGBA8, samples=1):
        ...
        if samples > 1:
            ...
            if (samples & (samples - 1)) != 0:
                ...
                raise ValueError(
                    'Invalid number of samples, must be <{}.'.format(
                        maxSamples))
    ...
    def bind(self):
        ...
        GL.glBindRenderbuffer(GL.GL_RENDERBUFFER, self.name)
...
defaultRenderbuffer = Renderbuffer(0, GL.GL_RENDERBUFFER, 0, 0, GL.GL_RGBA8, 1)
defaultRenderbufferEXT = Renderbuffer(0, GL.GL_RENDERBUFFER_EXT, 0, 0, GL.GL_RGBA8, 1)
