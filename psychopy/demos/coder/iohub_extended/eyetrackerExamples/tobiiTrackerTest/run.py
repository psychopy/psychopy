...
from psychopy.iohub import (DeviceEventTrigger, getCurrentDateTimeString,
                                   ...
                                   FullScreenWindow,ioHubExperimentRuntime,
                                   Computer,  EventConstants
                                   )
...
#        gaze_dot =visual.GratingStim(self.window,tex=None, mask="gauss", pos=(-2000,-2000),size=((r-l)*0.1,(t-b)*0.1),color='green')
        gaze_dot =visual.GratingStim(self.window,tex=None, mask="gauss", pos=(-2000,-2000),size=(2,2),color='red', units=display_coord_type)
        mouseDot =visual.GratingStim(self.window, units=display_coord_type,tex=None, mask="gauss", pos=(0,0),size=(1,1),color='blue')
