...
selfx = ShapeStim(win, vertices=selfxVert, fillColor='yellow', opacity=.6, pos=(.2,-.3), size=2)
...
lineA = ShapeStim(win, vertices=lineAVert, closeShape=False, lineWidth=2, pos=(-.3,.2), ori=180)
