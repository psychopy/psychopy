...
Displays information from ioHub Keyboard Events vs.
psychopy.event.geKeys().
...
title2_label = visual.TextStim(win, units=unit_type,
                               ...
                               alignVert='top',
                               wrapWidth=dw * 2)
key_text_label = visual.TextStim(
    win,
    units=unit_type,
    text=u'event.key:',
    pos=[
...
char_label = visual.TextStim(
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
modifiers_label = visual.TextStim(
    win,
    units=unit_type,
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
keypress_duration_label = visual.TextStim(
    win,
    units=unit_type,
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
all_pressed__label = visual.TextStim(
    win,
    units=unit_type,
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
event_type_label = visual.TextStim(
    win,
    units=unit_type,
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
psychopy_key_label = visual.TextStim(
    win,
    units=unit_type,
...
char_stim = visual.TextStim(
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
modifiers_stim = visual.TextStim(
    win,
    units=unit_type,
    text=u'',
    pos=[
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
keypress_duration_stim = visual.TextStim(
    win,
    units=unit_type,
    text=u'',
    pos=[
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
all_pressed_stim = visual.TextStim(
    win,
    units=unit_type,
    text=u'',
    pos=[
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
event_type_stim = visual.TextStim(
    win,
    units=unit_type,
    text=u'',
    pos=[
    ...
    height=TEXT_STIM_HEIGHT,
    wrapWidth=LABEL_WRAP_LENGTH)
psychopy_key_stim = visual.TextStim(
    win,
    units=unit_type,
    text=u'',
    pos=[
