...
def checkForSerialEvents(read_time, rx_data, parser_state, **kwargs):
    ...
    with any new serial events that have been found. Each element of the list
    must be a dict like object, representing a single serial device event
    found by the parsing function.
    ...
    :return: list of ioHub serial device events found.
    """
