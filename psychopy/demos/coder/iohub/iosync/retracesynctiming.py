...
blackstim = visual.ShapeStim(win,
                             ...
                             # beware, with convex shapes this won't work
                             fillColor=[-.25, -.25, -.25],
                             ...
                             # the anchor (rotaion and vertices are position
...
whitestim = visual.ShapeStim(win,
                             ...
                             vertices=sqrVertices,  # choose something from the above or make your own
                             closeShape=True,  # do you want the final vertex to complete a loop with 1st?
                             # pos= [0.5,0.5], #the anchor (rotaion and
                             # vertices are position with respect to this)
                             interpolate=True,
                             opacity=1,
                             autoLog=False)  # this stim changes too much for autologging to be useful
...
try:
    ...
    iohub_config = {
        ...
        # ['DigitalInputEvent']),
        'mcu.iosync.MCU': dict(serial_port='auto', monitor_event_types=['AnalogInputEvent']),
