...
class AnalogMeter(object):
    ...
    simple). A label can be displayed below the guage, and the guage value can
    be displayed as part of the guage background itself.
    ...
    def __init__(self, win, dial_color=[1, 1, 1],
        ...
        self.dial_bkgd_inner = visual.RadialStim(
            win=win,
            tex='None',
            units='pix',
            pos=(
...
class DigitalLineStateButton(object):
    """Displays a button graphic that changes based on it's state. A label can
    ...
    def __init__(self, win, dline_num, state_high_img, state_low_img,
        ...
        self.on_button = visual.ImageStim(
            win,
            size=size,
            image=state_high_img,
            units='pix',
            pos=pos,
            autoLog=False,
            name=title)
        self.off_button = visual.ImageStim(
            win,
            size=size,
            image=state_low_img,
            units='pix',
