...
class ExperimentRuntime(ioHubExperimentRuntime):
    ...
    the ioHubExperimentRuntime class. At minimum all that is needed is to
    override the run() method with the main experiment script logic.
    ...
    def run(self, *args):
        ...
        psychoStim['title'] = visual.TextStim(
            window, text='Analog Input Test. Trial 1 of %d' %
            (trial_count), pos=[
                0, 200], height=36, color=[
                1, .5, 0], colorSpace='rgb', alignHoriz='center', alignVert='center', wrapWidth=800.0)
        ...
        psychoStim['analog_input_values'] = visual.TextStim(
            window, text=ai_values_string_proto %
            ai_values, pos=[
                0, -200], height=24, color=[
                1, 1, 0], colorSpace='rgb', alignHoriz='center', alignVert='center', wrapWidth=800.0)
...
if __name__ == '__main__':
    ...
    def main(configurationDirectory):
        """Creates an instance of the ExperimentRuntime class, and launches the
        experiment logic in run()."""
