...
class EloTouchScreenDemo(ioHubExperimentRuntime):
    ...
    first perform a calibration / validation routine for the Touch Device (if
    calibrate_elo is True). If calibrate_elo is False, the last Touch device
    ...
    def run(self, *args):
        ...
        self.cal_instruct_stim = visual.TextStim(
            self.window,
            text='',
            pos=(
                0,
        ...
        self.touch_contingent_stim = visual.Circle(
            self.window,
            pos=(
                0,
                0),
        ...
        self.cal_instruct_stim.setText(
        ...
        while run_demo:
            ...
            if touch_events:
                ...
                touch_stim_radius = self.min_touch_stim_radius + \
...
if __name__ == '__main__':
    ...
    def main(configurationDirectory):
        """Creates an instance of the EloTouchScreenDemo class, and launches
        the experiment logic in run()."""
        runtime = EloTouchScreenDemo(
