...
"""Illustrates using psychopy.contrib.http.post.upload() to send a file to a configured server
...
status = post.upload(selector, filename, basicAuth) # do the upload, get return status
