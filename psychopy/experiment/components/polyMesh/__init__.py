...
class PolygonMeshComponent(BaseVisualComponent):
    """A class for presenting a 3D polygon mesh as a builder component
    """

    categories = ['Stimuli']
    targets = ['PsychoPy']
    iconFile = Path(__file__).parent / 'polymesh.png'
    tooltip = _translate('Polygon Mesh: A component for presenting 3D polygon meshes')
    ...
    def __init__(self, exp, parentName,
        ...
        super(PolygonMeshComponent, self).__init__(
                exp, parentName, name,
                pos=pos, size=size,
        ...
        self.order += ['forceEndRoutine',  # Basic tab
                       'material', 'styles', 'styleTweaks', # Appearance tab
                       'font',  # Formatting tab
                       'flip',  # Layout tab
        ...
        self.params['initVal'] = Param(
            ...
            hint=_translate("Value of the slider before any response, leave blank to hide the marker until clicked on"),
        ...
        # Appearance params
        # Params for the lighting model / material to apply to the mesh

        # Blinn-Phong lighting model --------------------------------------------------

        lightModel = 'Blinn-Phong'
        self.params['lightModel'] = Param(
                lightModel, valType='choice', inputType="choice", categ='Appearance',
                updates='constant', allowedUpdates=[], allowedVals=['Blinn-Phong', 'None'],
                hint=_translate("Lighting model to apply to the mesh"),
                label=_translate("Light model"))
        
        # conditional fields for when Blinn-Phong is selected
        ...
        #     {
        #         # if...
        #         "dependsOn": "lightModel",
        #         # meets...
        #         "condition": "=='Blinn-Phong'",
        #         # then...
        #         "param": "ambientColor",
        #         # should...
        #         "true": "show",
        ...
        #     }
        # )
        # self.params['ambientColor'] = Param(
        #         ambientColor, valType='color', inputType="color", categ='Appearance',
        #         updates='constant', allowedUpdates=[],
        #         hint=_translate("Color of the ambient light"),
        #         label=_translate("Ambient color"))
        # diffuseColor
        ...
        self.params['diffuseColor'] = Param(
                diffuseColor, valType='color', inputType="color", categ='Appearance',
                updates='constant', allowedUpdates=[],
                hint=_translate("Color of the diffuse light"),
                label=_translate("Diffuse color"))
        # specularColor
        specularColor = 'White'
        self.depends.append(
            {
        ...
        self.params['specularColor'] = Param(
                specularColor, valType='color', inputType="color", categ='Appearance',
                updates='constant', allowedUpdates=[],
                hint=_translate("Color of the specular light"),
                label=_translate("Specular color"))
        # emissionColor
        emissionColor = 'Black'
        self.depends.append(
            {
        ...
        self.params['emissionColor'] = Param(
                emissionColor, valType='color', inputType="color", categ='Appearance',
                updates='constant', allowedUpdates=[],
                hint=_translate("Color of the light emitted by the material"),
                label=_translate("Emission color"))
        # shininess
        shininess = 100.0
        self.depends.append(
            {
        ...
        self.params['shininess'] = Param(
                shininess, valType='num', inputType="single", categ='Appearance',
                updates='constant', allowedUpdates=[],
                hint=_translate("Shininess of the material"),
                label=_translate("Shininess"))
