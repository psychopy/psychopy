...
class KeyboardComponent(BaseComponent):
    ...
    def writeFrameCodeJS(self, buff):
        ...
        if store != 'nothing' or forceEnd:
            ...
            code = ("_{name}_allKeys = _{name}_allKeys.concat(theseKeys);\n"
