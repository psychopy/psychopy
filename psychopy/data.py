...
from psychopy.misc.arraytools import extendArr, shuffleArray
...
class ExperimentHandler(object):
    ...
    def saveAsPickle(self,fileName, fileCollisionMethod = 'rename'):
        ...
        :Parameters:
            ...
            fileCollisionMethod: Collision method passed to :func:`~psychopy.misc.fileerrortools.handleFileCollision`
        """
...
class TrialHandler(_BaseTrialHandler):
    ...
    saved it. You can open it with::
            ...
            dat = misc.filetools.fromFile(path)
