...
def test_param_str():
    ...
    cases = [
        ...
        {"obj": Param("\\, | or /", "str", canBePath=False),
         "py": f"{_q}{_sl}{_sl}, \| or /{_q}",
         "js": f"{_q}{_sl}{_sl}, \| or /{_q}"},
        # Dollar string
        ...
        # URL
        {"obj": Param("http://www.google.com", "str"),
         "py": f"{_q}http://www.google.com{_q}",
         "js": f"{_q}http://www.google.com{_q}"},
        # Table path
        ...
        {"obj": Param("This \\ that", "str"),
         "py": f"{_q}This {_sl}{_sl} that{_q}",
         "js": f"{_q}This {_sl}{_sl} that{_q}"},
        ...
        {'obj': Param("[\'left\', \'down\', \'right\']", "list"),
         ...
         'js': f"{_lb}{_q}left{_q}, {_q}down{_q}, {_q}right{_q}{_rb}"},
        # Single value
        # todo: this doesn't work in JS due to the transpiler expression bug
        {'obj': Param("\"left\"", "list"),
