...
# We deliberately delay importing the inpoutx64 module until we try
...
class PParallelInpOutx64(object):
    """This class provides read/write access to the parallel port on a PC
    using inpoutx64 (for instance for Windows 7 64-bit)
    """
    ...
    def readPin(self, pinNumber):
        ...
        if pinNumber == 10:
            ...
            msg = 'Pin %i cannot be read (by PParallelInpOutx64.readPin())'
            print(msg % pinNumber)
